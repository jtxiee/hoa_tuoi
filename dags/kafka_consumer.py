...
def kafka_bigquery(bootstrap_servers, topic, consumer_group):
    ...
    # ck-huynhhuuquoc.hoatuoi.hoatuoi_table.
    def consume_loop(consumer, topic):
        bigquery_client = bigquery.Client()
        # Thay doi
        dataset_id = "hoatuoi"
        # Thay doi
        table_id = "hoatuoi_table"
    ...
    def define_schema():
        # Thay doi theo file
        return [
            bigquery.SchemaField("tenhoa", "STRING", mode="REQUIRED"),
            bigquery.SchemaField("giahoa", "STRING", mode="REQUIRED"),
            bigquery.SchemaField("mota", "STRING", mode="REQUIRED"),
            bigquery.SchemaField("thanhphan", "STRING", mode="REQUIRED"),
        ]
